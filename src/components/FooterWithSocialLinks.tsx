...
export function FooterWithSocialLinks(): JSX.Element {
  return (
    <section className="absolute w-dvw py-10 bg-gray-50 sm:pt-16 lg:pt-24">
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
          <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
            ...
            <Image src={logo.src} className="w-auto h-9" width="100" height="100" alt="" priority />
